                          ...
                          onClick={() =>
                            window.open(
                              `https://wa.me/+91${
                                ...
                                `Hello ${seller.seller.name}, greetings from GecBazaar! I'm interested in purchasing your listed product ${seller.item.title} priced at  Rs.${seller.item.price}/- Please respond to your earliest convenience. Thank you!`
                              )}`,
                              "_blank"
                            )
                          }
