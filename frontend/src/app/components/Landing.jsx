                ...
                <section class="bg-white">
                    <div class="h-[32rem] bg-gray-100">
                        <div class="container mx-auto px-6 py-10">
                            ...
                            <p class="mx-auto mt-6 max-w-2xl text-center text-gray-500">Second year Computer Engineering students from Goa Enginering college, having the passion to build a tech around every problem we discover</p>
                        </div>
                    </div>
                    ...
                    <div class="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
                        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-3">
                            <div class="flex flex-col items-center rounded-xl border p-4 sm:p-6">
                                ...
                                <p class="mt-2 capitalize text-gray-500">Frontend Developer</p>
                    ...
                    <div class="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
                        <div class="mt-8 grid grid-cols-2 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-2">
                            <div class="flex flex-col items-center rounded-xl border p-4 sm:p-6">
                                <img class="aspect-square w-full rounded-xl object-cover" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
